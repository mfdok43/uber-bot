...
import {GetUsersByPrivileged, GetUsers, GetUsersBySeller} from "../../common/sequelize/user-model.sequelize";

export class MainMenu {
    markup: any
    constructor() {
            this.markup = [ { text: `Channels list`, callback_data: "viewChannels" },
